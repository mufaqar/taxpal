...
export function Pricing({pricingTables}) {
  ...
  let pricing_Tables = pricingTables.pricingTables
  let landing = pricingTables.landingPage.pricingTable
        ...
        <div className="md:text-center">
          <p className="text-3xl tracking-tight text-white font-display sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">{landing.titleInSpan} </span>
            </span>
            {landing.titleAfterSpan}
          </p>
          ...
          <Plan
            ...
            price= {pricing_Tables[0].pricingTable.planPrice}
            description= {pricing_Tables[0].pricingTable.shortDiscription}
            href= {pricing_Tables[0].pricingTable.getStartedLink}
            features= {pricing_Tables[0].pricingTable.featuresList}
          />
          <Plan
            featured = {pricing_Tables[1].pricingTable.featuredType}
            name= {pricing_Tables[1].pricingTable.planType}
            price= {pricing_Tables[1].pricingTable.planPrice}
            description= {pricing_Tables[1].pricingTable.shortDiscription}
            href= {pricing_Tables[1].pricingTable.getStartedLink}
            features= {pricing_Tables[1].pricingTable.featuresList}
          />
